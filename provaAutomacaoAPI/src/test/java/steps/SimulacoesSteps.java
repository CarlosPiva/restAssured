...
public class SimulacoesSteps {
    ...
    @Quando("ele acessar a aplicação")
    public void eleAcessarAAplicação() {
        simulacoesAction.consultarTodasSimulacoes();
    }

    @Então("os campos dever ver iguais ao do contrato")
    public void osCamposDeverVerIguaisAoDoContrato() {
        simulacoesAction.validarContrato();
    }
}
